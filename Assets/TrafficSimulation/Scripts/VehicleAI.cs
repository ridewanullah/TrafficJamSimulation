...
namespace TrafficSimulation {
    ...
    /*
        ...
        [-] Make Collision Detection in intersection
    ...
    */
    ...
    public class VehicleAI : MonoBehaviour
    {
        ...
        void CheckingCollision(){
            if (isOnIntersection && acc == 0){
                countDown += Time.deltaTime;
                if (countDown <= 0f) hasCollision = true;
            } else countDown = 10f;
        }
        ...
        void MoveVehicle(){
            ...
            if(vehicleStatus == Status.STOP){
                ...
                // Debug.Log($"Vehicle {gameObject.name} status: {vehicleStatus}");
            }
            else{
        ...
        GameObject GetDetectedObstacles(out float _hitDist){
            ...
            // Debug.Log(detectedObstacle.gameObject.name);
