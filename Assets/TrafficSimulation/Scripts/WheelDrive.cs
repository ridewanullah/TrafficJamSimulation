    ...
    public class WheelDrive : MonoBehaviour
    {
        ...
        public void Move(float _acceleration, float _steering, float _brake)
        {
            ...
            foreach (WheelCollider wheel in wheels){
                ...
                if (transform.eulerAngles.z > 60f || transform.eulerAngles.z < -60f){
                    transform.eulerAngles = new Vector3(transform.eulerAngles.x, transform.eulerAngles.y, 0f);
                } else if (transform.eulerAngles.x > 90f || transform.eulerAngles.x < -90f){
        ...
        public float GetSpeedMS() {
            ...
            return GetSpeedMS(rb.velocity.magnitude);
        }
    }   
}
